...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "best_resnet18_coral_bml.pth")
    ...
    # NEW CORAL CODE:
    model.load_state_dict(torch.load("best_resnet18_coral_bml.pth", map_location=device))
    ...
    save_results_json(
    output_path="results_resnet18_coral.json",
    model_name="ResNet18",
    loss_name="CORAL",
